...
keys = [
    ...
    Key([mod], "d", lazy.spawn("rofi -show notes"), desc="Show notes menu"),
    Key([mod], "n", lazy.spawn(terminal + " nvim"), desc="Open NeoVim editor"),
    Key(
        [mod],
        "z",
...
groups = [
    ScratchPad(
        "scratchpad",
        [
            DropDown("term", dropdown_terminal, wrap_pointer=True, on_focus_lost_hide=False),
            DropDown(
                "notes",
